...
import 'package:evatsignature/Provider/expense_category_proivder.dart';
import 'package:evatsignature/constant.dart';
import 'package:evatsignature/generated/l10n.dart' as lang;
import 'package:evatsignature/model/expense_category_model.dart';
                ...
                children: [
                  ...
                  ButtonGlobalWithoutIcon(
                    ...
                    onPressed: () async {
                      ...
                      isAlreadyAdded ? EasyLoading.showError('Already Added') : categoryInformationRef.push().set(categoryModel.toJson());
                      setState(() {
                        showProgress = false;
