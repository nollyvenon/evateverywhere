...
class S {
  ...
  /// `Stay at the forefront of technological advancements without any extra costs. Our Evat Signature POS Unlimited Upgrade ensures that you always have the latest tools and features at your fingertips, guaranteeing your business remains cutting-edge.`
  ...
  /// `Unlock the full potential of Evat Signature POS with personalized training sessions led by our expert team. From the basics to advanced techniques, we ensure you're well-versed in utilizing every facet of the system to optimize your business processes.`
  ...
  /// `The name says it all. With Evat Signature POS Unlimited, there's no cap on your usage. Whether you're processing a handful of transactions or experiencing a rush of customers, you can operate with confidence, knowing you're not constrained by limits`
  ...
  /// `Safeguard your business data effortlessly. Our Evat Signature POS Unlimited Upgrade includes free data backup, ensuring your valuable information is protected against any unforeseen events. Focus on what truly matters - your business growth.`
  ...
  /// `You are successfully login into your account. Stay with Evat Signature .`
  ...
  /// `Evat Signature  app is free, easy to use. In fact, it's one of the best  POS systems around the world.`
  ...
  /// `Features are the important part which makes Evat Signature  different from traditional solutions.`
  ...
  /// `Evat Signature  is a complete business solution with stock, account, sales, expense & loss/profit.`
