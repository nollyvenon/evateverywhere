...
class _ExcelUploaderState extends State<ExcelUploader> {
  ...
  Future<void> createExcelFile() async {
    ...
    final List<e.CellValue> excelData = [
      const e.TextCellValue('SL'),
      const e.TextCellValue('Product Name*'),
      const e.TextCellValue('Product Code*'),
      const e.TextCellValue('Product Stock*'),
      const e.TextCellValue('Purchase Price*'),
      const e.TextCellValue('Sale Price*'),
      const e.TextCellValue('Wholesale Price'),
      const e.TextCellValue('Dealer Price'),
      const e.TextCellValue('Category*'),
      const e.TextCellValue('Brand'),
      const e.TextCellValue('Units'),
      const e.TextCellValue('Manufacturer'),
      const e.TextCellValue('Manufacture Date (ex: Month/Day/Year)'),
      const e.TextCellValue('Expire Data (ex: Month/Day/Year)'),
      const e.TextCellValue('Low Stock Alert'),
      const e.TextCellValue('Serial Numbers (ex. TFD3763, 34384SJHG)'),
    ];
