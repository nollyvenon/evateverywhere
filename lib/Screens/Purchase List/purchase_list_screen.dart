...
import 'package:evatsignature/Provider/print_purchase_provider.dart';
import 'package:evatsignature/Provider/transactions_provider.dart';
import 'package:evatsignature/Screens/Purchase%20List/purchase_list_edit_screen.dart';
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child: const Text('Yes, Delete Forever').onTap(() async {
                                                                            ...
                                                                            DatabaseReference firebaseRef = FirebaseDatabase.instance
                                                                                .ref("$constUserId/Purchase Transition/${reTransaction[index].key}");
