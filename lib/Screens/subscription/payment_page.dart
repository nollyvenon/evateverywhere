...
import 'package:evatsignature/Functions/webview_screen.dart';
import 'package:evatsignature/constant.dart' as cns;
import 'package:evatsignature/model/payment_model.dart';
import 'package:evatsignature/repository/bank_info_repo.dart';
  ...
  _handlePayment(String totalAmount, String currency) {
    ...
    case 'Kkipay':
      ...
      case 'Paystack':
        PayWithPayStack().now(
            context: context,
            secretKey: widget.paymentModel.payStackInfoModel.payStackPublicKey,
